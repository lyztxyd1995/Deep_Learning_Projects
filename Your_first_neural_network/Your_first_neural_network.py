...
# As it is shown on the figure above, the prediction fits well with the data except for the time from Dec 22th to Dec 26th, which I think it may be due to the reaseon the we have not considered the influence of holiday in our model(Since it is Christmas during that time period).
